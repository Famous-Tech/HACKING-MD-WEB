...
export default function QRCode() {
  ...
  const fetchQRCode = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await fetch('https://hacking-md-pairing.onrender.com/api/auth?mode=qr');
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold text-white">Scanner le QR Code</h2>
          <p className="mt-2 text-gray-300">
            Ouvrez WhatsApp sur votre téléphone et scannez le QR code pour vous connecter
          </p>
        </div>
